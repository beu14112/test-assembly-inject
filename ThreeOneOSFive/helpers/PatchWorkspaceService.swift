...
enum PatchWorkspaceService {
    ...
    private static let manifestFilename = ".beu-project.plist"
    private static let legacyManifestFilename = ".3105-project.plist"
    ...
    static func replaceWorkspace(
        ...
        let displaced = root.appendingPathComponent(
            ".beu-displaced-workspace-\(UUID().uuidString)",
            isDirectory: true
        )
    ...
    static func snapshot(
        ...
        let topLevel = try fileManager.contentsOfDirectory(
            ...
            $0.lastPathComponent != manifestFilename && $0.lastPathComponent != legacyManifestFilename
        }
    ...
    private static func readManifest(workspaceURL: URL) throws -> Manifest {
        let candidates = [manifestFilename, legacyManifestFilename]
